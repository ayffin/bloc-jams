...
var findParentByClassName = function(element, cl) {
...
var getSongItem = function(element) {
  switch (element.className) {
    ...
    case 'song-item-duration':
      return findParentByClassName(element, 'album-view-song-item').querySelector(
        '.song-item-number');
...
var clickHandler = function(targetElement) {
  ...
  if (currentlyPlayingSong === null) {
  ...
  } else if (currentlyPlayingSong === songItem.getAttribute(
      'data-song-number')) {
    ...
    currentlyPlayingSong = null;
      ...
      'data-song-number')) {
    var currentlyPlayingSongElement = document.querySelector(
      '[data-song-number="' + currentlyPlayingSong + '"]');
...
var songListContainer = document.getElementsByClassName(
